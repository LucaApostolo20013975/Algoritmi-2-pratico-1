...
vertices must already be contained in this graph. If they are not found
     ...
     * @throws NullPointerException if any of the vertices belonging to the edge is <code>
     * null</code>.
     *
     */
     ...
     * to the target vertex. If any of the specified vertices does not exist in the graph, or if is <code>
     ...
     * 
     * <p>
     * A degree of a vertex in an undirected graph is the 
 of edges touching that vertex.
